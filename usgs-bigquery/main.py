...
BQ_DATASET = 'Disaster_data'
BQ_TABLE = 'usgs_data'
ERROR_TOPIC = 'projects/%s/topics/%s' % (PROJECT_ID, 'usgs_error_topic')
SUCCESS_TOPIC = 'projects/%s/topics/%s' % (PROJECT_ID, 'usgs_success_topic')
DB = firestore.Client()
CS = storage.Client()
...
def usgs_bigquery(data, context):
